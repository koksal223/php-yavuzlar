...
Ad: <br>
<input type="text" readonly value="İrsad Salih Koksal" name="ad">
<hr>
Hakkımda: <br>
...
<select name="meslek">
    <option>-- seç --</option>
    <option <?php echo post('meslek') == 'Cyber-security-engineer' ? ' selected' : null ?> value="Cyber-security-engineer">Cyber security engineer</option>
...
<select name="meslek2[]" multiple size="5">
    <option>-- seç --</option>
    <option selected value="Cyber-security-engineer">Cyber security engineer</option>
